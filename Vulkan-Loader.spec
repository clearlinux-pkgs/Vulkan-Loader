...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.261/Vulkan-Loader-1.3.261.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.261
cd %{_builddir}/Vulkan-Loader-1.3.261
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691433109
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.261
...
/usr/lib32/libvulkan.so.1.3.261
