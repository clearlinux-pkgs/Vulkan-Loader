...
Version  : 1.4.323
Release  : 191
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.4.323/Vulkan-Loader-1.4.323.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.4.323/Vulkan-Loader-1.4.323.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.4.323
cd %{_builddir}/Vulkan-Loader-1.4.323
pushd ..
cp -a Vulkan-Loader-1.4.323 build32
popd
pushd ..
cp -a Vulkan-Loader-1.4.323 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1753107334
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.4.323
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.4.323

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.4.323
