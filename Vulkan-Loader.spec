...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.231/Vulkan-Loader-1.3.231.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.231
cd %{_builddir}/Vulkan-Loader-1.3.231
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665694893
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libvulkan.so.1.3.231

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.231
