...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.241/Vulkan-Loader-1.3.241.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.241
cd %{_builddir}/Vulkan-Loader-1.3.241
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677001669
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libvulkan.so.1.3.241

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.241
