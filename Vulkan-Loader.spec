...
Version  : 1.4.303
Release  : 175
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.4.303/Vulkan-Loader-1.4.303.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.4.303/Vulkan-Loader-1.4.303.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.4.303
cd %{_builddir}/Vulkan-Loader-1.4.303
pushd ..
cp -a Vulkan-Loader-1.4.303 build32
popd
pushd ..
cp -a Vulkan-Loader-1.4.303 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733325891
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.4.303
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.4.303
