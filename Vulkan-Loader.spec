...
%prep
%setup -q -n Vulkan-Loader-1.2.157
cd %{_builddir}/Vulkan-Loader-1.2.157
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602801140
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Loader-1.2.157/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Loader/9bf8124f4495a48c4fd7104aebe2e957176b930b
pushd clr-build32
%make_install32
