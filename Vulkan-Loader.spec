...
Version  : 1.3.298
Release  : 170
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.298/Vulkan-Loader-1.3.298.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.298/Vulkan-Loader-1.3.298.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.298
cd %{_builddir}/Vulkan-Loader-1.3.298
pushd ..
cp -a Vulkan-Loader-1.3.298 build32
popd
pushd ..
cp -a Vulkan-Loader-1.3.298 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728922935
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.298
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.3.298

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.298
