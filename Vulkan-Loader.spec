...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.278/Vulkan-Loader-1.3.278.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.278
cd %{_builddir}/Vulkan-Loader-1.3.278
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708118886
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.278
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.3.278

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.278
