...
Version  : 1.3.283
Release  : 157
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.283/Vulkan-Loader-1.3.283.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.283/Vulkan-Loader-1.3.283.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.283
cd %{_builddir}/Vulkan-Loader-1.3.283
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713672540
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.283
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.3.283
