...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.2.188/Vulkan-Loader-1.2.188.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.2.188
cd %{_builddir}/Vulkan-Loader-1.2.188
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629139348
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Loader-1.2.188/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Loader/9bf8124f4495a48c4fd7104aebe2e957176b930b
pushd clr-build32
%make_install32
