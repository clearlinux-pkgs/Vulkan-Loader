...
Version  : 1.3.287
Release  : 160
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.287/Vulkan-Loader-1.3.287.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.287/Vulkan-Loader-1.3.287.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.287
cd %{_builddir}/Vulkan-Loader-1.3.287
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718233417
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.287
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.3.287

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.287
