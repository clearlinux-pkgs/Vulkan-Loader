...
Version  : 1.3.290
Release  : 163
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.290/Vulkan-Loader-1.3.290.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.290/Vulkan-Loader-1.3.290.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.290
cd %{_builddir}/Vulkan-Loader-1.3.290
pushd ..
cp -a Vulkan-Loader-1.3.290 build32
popd
pushd ..
cp -a Vulkan-Loader-1.3.290 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721066541
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.290
...
/usr/lib32/libvulkan.so.1.3.290
