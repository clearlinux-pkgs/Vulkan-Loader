...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.269/Vulkan-Loader-1.3.269.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.269
cd %{_builddir}/Vulkan-Loader-1.3.269
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698075015
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.269
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.3.269

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.269
