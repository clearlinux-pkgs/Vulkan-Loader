...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.228/Vulkan-Loader-1.3.228.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.228
cd %{_builddir}/Vulkan-Loader-1.3.228
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663348664
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libvulkan.so.1.3.228

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.228
