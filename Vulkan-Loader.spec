...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.2.191/Vulkan-Loader-1.2.191.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.2.191
cd %{_builddir}/Vulkan-Loader-1.2.191
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631223996
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Loader-1.2.191/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Loader/9bf8124f4495a48c4fd7104aebe2e957176b930b
pushd clr-build32
%make_install32
...
/usr/lib64/libvulkan.so.1.2.191

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.2.191
