...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.4.309/Vulkan-Loader-1.4.309.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.4.309
cd %{_builddir}/Vulkan-Loader-1.4.309
pushd ..
cp -a Vulkan-Loader-1.4.309 build32
popd
pushd ..
cp -a Vulkan-Loader-1.4.309 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740180134
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.4.309
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.4.309
