...
Version  : 1.3.288
Release  : 161
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.288/Vulkan-Loader-1.3.288.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.288/Vulkan-Loader-1.3.288.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.288
cd %{_builddir}/Vulkan-Loader-1.3.288
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718607495
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.288
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.3.288

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.288
