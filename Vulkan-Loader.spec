...
Version  : 1.4.322
Release  : 190
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.4.322/Vulkan-Loader-1.4.322.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.4.322/Vulkan-Loader-1.4.322.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.4.322
cd %{_builddir}/Vulkan-Loader-1.4.322
pushd ..
cp -a Vulkan-Loader-1.4.322 build32
popd
pushd ..
cp -a Vulkan-Loader-1.4.322 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752581192
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.4.322
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.4.322

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.4.322
