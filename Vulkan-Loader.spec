...
Version  : 1.3.301
Release  : 173
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.301/Vulkan-Loader-1.3.301.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.301/Vulkan-Loader-1.3.301.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.301
cd %{_builddir}/Vulkan-Loader-1.3.301
pushd ..
cp -a Vulkan-Loader-1.3.301 build32
popd
pushd ..
cp -a Vulkan-Loader-1.3.301 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730754766
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvulkan.so.1.3.301
/usr/lib64/libvulkan.so.1
/usr/lib64/libvulkan.so.1.3.301

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.301
