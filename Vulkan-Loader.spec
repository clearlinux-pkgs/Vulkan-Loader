...
Version  : 1.3.242
Release  : 120
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.242/Vulkan-Loader-1.3.242.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.3.242/Vulkan-Loader-1.3.242.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.3.242
cd %{_builddir}/Vulkan-Loader-1.3.242
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677549212
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libvulkan.so.1.3.242

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.3.242
